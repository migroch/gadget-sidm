...
Definition at line 544 of file gravtree.c.
...
\begin{DoxyCode}
{
  ...
  while(ntotleft > 0)
    {
      ...
      Task]].u.Acc[k];
#ifdef COMPUTE_SELFINTERACTION_FORDARK
                          if( All.ErrTolTheta == 0 || All.TypeOfOpeningCriterion 
      == 0)
                            {
                              for(k = 0; k < 3; k++)
                                P[place].Vel[k] += GravDataOut[j + noffset[recvTa
      sk]].Vel[k];
                            }
#endif
  ...
  MPI_Gather(&All.Nself_interactions, 1, MPI_UNSIGNED_LONG, Nself_interactionsLis
      t, 1, MPI_UNSIGNED_LONG, 0, MPI_COMM_WORLD);
#endif
...
Definition at line 487 of file gravtree.c.
