...
\item 
void \hyperlink{sidm__routines_8c_a6754f6d28b3de6f16e3f98d6f79b5719}{update\_\-interaction\_\-table} (unsigned int id1, unsigned int id2)
\item 
int \hyperlink{sidm__routines_8c_a74f3632c9a90fd460cb308e906b91d5d}{check\_\-interaction\_\-table} (unsigned int id1, unsigned int id2)
\end{DoxyCompactItemize}
...
\hypertarget{sidm__routines_8c_a74f3632c9a90fd460cb308e906b91d5d}{
...
\label{sidm__routines_8c_a74f3632c9a90fd460cb308e906b91d5d}
...
Definition at line 280 of file sidm\_\-routines.c.
...
\begin{center}
\leavevmode
\includegraphics[width=400pt]{sidm__routines_8c_a74f3632c9a90fd460cb308e906b91d5d_icgraph}
\end{center}
\end{figure}
...
\begin{DoxyCode}
  {
    ...
    mp =  All.MassTable[1]*All.UnitMass_in_g*(2.998e10)*(2.998e10)*624.15097;  /*
       convert particle mass to Gev */
...
\hypertarget{sidm__routines_8c_a6754f6d28b3de6f16e3f98d6f79b5719}{
...
\label{sidm__routines_8c_a6754f6d28b3de6f16e3f98d6f79b5719}
      ...
      for(i = 0; i < INTERACTION_TABLE_LENGTH; i++)
        {
          ...
          printf("ERROR: There were more interactions in this timestep than INTER
      ACTION_TABLE_LENGTH. Calling endrun()");
          endrun(1);
        }
    }
  else
      ...
      for(j = 1; j < PARTICLE_MAX_INTERACTIONS; j++)
        {
          ...
          printf("ERROR: A particle interacted with more than PARTICLE_MAX_INTERA
      CTIONS. Calling endrun()");
          endrun(1);
        }
    } 
...
\begin{center}
\leavevmode
\includegraphics[width=400pt]{sidm__routines_8c_a6754f6d28b3de6f16e3f98d6f79b5719_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=400pt]{sidm__routines_8c_a6754f6d28b3de6f16e3f98d6f79b5719_icgraph}
\end{center}
\end{figure}
